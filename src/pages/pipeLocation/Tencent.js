...
const getContianer = dom => {
    ...
    middleControl.innerHTML = `<img src="${require('../../image/spot_location.png')}" style="width: 100%;height: 100%;" />`;
    dom.appendChild(middleControl);
}

export default () => (
    <ReactQMap
        center={{latitude:30.51911 , longitude: 114.350382}} 
        initialOptions={{zoomControl: true, mapTypeControl: true}} 
        apiKey="UN6BZ-MP2W6-XWCSX-M2ATU-QORGZ-OWFOE"
        style={{height: 500}}
        mySpot={{latitude:30.51911 , longitude: 114.350382}}
